...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-mitml-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-mitml-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-mitml-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-mitml-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-mitml-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-mitml-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-mitml` can be installed with:

```
conda install r-mitml
```

It is possible to list all of the versions of `r-mitml` available on your platform with:
